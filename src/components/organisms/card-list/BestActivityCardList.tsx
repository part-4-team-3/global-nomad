...
export default function BestActivityCardList({ activitiesData, carouselRef }: Props) {
  return (
    <div className="w-full">
      <div
        ref={carouselRef}
        className="flex snap-x snap-mandatory scroll-px-[16px] gap-[16px] overflow-x-auto px-[16px] py-[10px] scrollbar-hide md:scroll-px-[24px] md:gap-[24px] md:px-[24px] xl:scroll-px-[0px] xl:px-[0px]"
      >
