...
export default function BestActivityCard() {
  return (
    <Link
      href=""
      className="relative flex size-186pxr overflow-hidden rounded-[20px] md:size-384pxr"
    >
      <Image
      ...
      />
      <div
        className="relative flex flex-col justify-end gap-6pxr px-20pxr py-24pxr md:gap-20pxr md:py-30pxr"
        style={{
          background:
      ...
      >
        ...
        <h3 className="w-full break-keep text-18pxr font-[700] leading-[120%] text-white md:w-[80%] md:text-30pxr">
          함께 배우면 즐거운 스트릿 댄스
        </h3>
        <div className="flex items-center gap-5pxr">
          <b className="text-16pxr font-[700] text-white md:text-20pxr">₩ 190000</b>
